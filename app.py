...
# --- [UPDATE ข้อ 4] ปรับปรุงฟังก์ชันย่อรูปให้ไฟล์เล็ก เก็บได้นาน ---
def process_image(img_file):
    ...
    try:
        ...
        # ย่อขนาดรูปไม่ให้เกิน 800px (ลดภาระ Google Sheets)
        img.thumbnail((800, 800))
        buffer = io.BytesIO()
        
        # ลดคุณภาพ JPEG เหลือ 65% (ไฟล์เล็กลงมากแต่ยังชัด)
