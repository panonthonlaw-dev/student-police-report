...
def main_page():
    ...
    with tab1:
        ...
        with st.form("report_form", clear_on_submit=True):
            ...
            # 🔴 ส่วนที่เพิ่ม: คำเตือนข้อกฎหมายสีแดง
            st.markdown("""
            <div style='background-color: #fef2f2; border: 1px solid #fecaca; padding: 10px; border-radius: 5px; margin-top: 5px; margin-bottom: 15px;'>
                <p style='color: #dc2626; font-size: 14px; margin: 0; font-weight: bold;'>
                    ⚠️ คำเตือน: การแจ้งความเท็จเพื่อแกล้งผู้อื่นผิดกฎหมายอาญา <br>
                    และการแจ้งนี้เป็นเพียงการแจ้งเหตุภายในโรงเรียน ไม่ใช่การแจ้งความตามกฎหมาย
                </p>
            </div>
            """, unsafe_allow_html=True)
            # ----------------------------------------
