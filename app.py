...
def main_page():
    ...
    with tab1:
        # ==========================================
        # 🔒 ปิดระบบ GPS ชั่วคราว
        # ==========================================
        # (โค้ด GPS ถูกซ่อนไว้ตามคำขอ)
        # ==========================================
        ...
        with st.form("report_form", clear_on_submit=True):
            ...
            # =========================================================
            # 🔴🔴 บังคับแสดงผลกล่องแดง (Hardcode HTML)
            # =========================================================
            st.markdown("""
            <div style="background-color: #fce8e6; border: 1px solid #ea4335; border-radius: 5px; padding: 15px; margin-top: 10px; margin-bottom: 20px;">
                <p style="color: #d93025; font-weight: bold; font-size: 16px; margin: 0;">
                    ⚠️ คำเตือนสำคัญ
                </p>
                <p style="color: #202124; font-size: 14px; margin-top: 5px;">
                    การแจ้งความเท็จเพื่อแกล้งผู้อื่นมีความผิดตามกฎหมายอาญา <br>
                    และการแจ้งนี้ไม่ใช่การแจ้งความดำเนินคดีตามกฎหมาย (เป็นเพียงการแจ้งเหตุภายในโรงเรียน)
                </p>
            </div>
            """, unsafe_allow_html=True)
            # =========================================================
            ...
            if submitted:
                # กำหนดค่าพิกัดเป็นว่างเปล่าไปก่อน (เพราะปิด GPS)
                current_lat = "" 
                current_lon = ""
